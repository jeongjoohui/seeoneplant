...
$info->action->procMemberSendVerificationSMS = new stdClass;
$info->action->procMemberSendVerificationSMS->type='controller';
$info->action->procMemberSendVerificationSMS->grant='guest';
$info->action->procMemberSendVerificationSMS->standalone='true';
$info->action->procMemberSendVerificationSMS->ruleset='';
$info->action->procMemberSendVerificationSMS->method='';
$info->action->procMemberSendVerificationSMS->check_csrf='true';
$info->action->procMemberSendVerificationSMS->meta_noindex='false';
$info->action->procMemberConfirmVerificationSMS = new stdClass;
$info->action->procMemberConfirmVerificationSMS->type='controller';
$info->action->procMemberConfirmVerificationSMS->grant='guest';
$info->action->procMemberConfirmVerificationSMS->standalone='true';
$info->action->procMemberConfirmVerificationSMS->ruleset='';
$info->action->procMemberConfirmVerificationSMS->method='';
$info->action->procMemberConfirmVerificationSMS->check_csrf='true';
$info->action->procMemberConfirmVerificationSMS->meta_noindex='false';
