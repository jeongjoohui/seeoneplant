...
new ConditionWithArgument('`upload_target_srl`',$upload_target_srl1_argument,"equal", 'and')
,new ConditionWithArgument('`regdate`',$regDate2_argument,"like_prefix", 'and')),'and')
));
