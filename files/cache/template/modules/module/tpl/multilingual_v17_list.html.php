...
<fieldset class="list">
	<?php if($__Context->lang_code_list)foreach($__Context->lang_code_list as $__Context->no=>$__Context->val){ ?><form action="" class="item"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		...
		<fieldset id="lang-<?php echo $__Context->no ?>" style="display:none">
			<?php if($__Context->lang_supported)foreach($__Context->lang_supported as $__Context->code=>$__Context->lname){ ?><textarea disabled class="<?php echo $__Context->code ?>" data-lang="<?php echo $__Context->code ?>" rows="1" cols="12" title="<?php echo $__Context->lname ?>" style="margin-right:5px"></textarea><?php } ?>
...
<div class="x_clearfix">
	...
	<form action="" class="search center x_input-append x_pull-right"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		<select name="lang_code" style="margin-right:4px">
			<?php if($__Context->lang_supported)foreach($__Context->lang_supported as $__Context->code=>$__Context->lname){ ?><option value="<?php echo $__Context->code ?>"<?php if($__Context->code == $__Context->lang_code){ ?> selected="selected"<?php } ?>><?php echo $__Context->lname ?></option><?php } ?>
		</select>
