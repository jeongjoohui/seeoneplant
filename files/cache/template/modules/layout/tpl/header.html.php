...
<div class="x_page-header">
	<h1>
		<?php echo $lang->installed_layout ?>
...
<?php if($__Context->layout == 'faceoff'){ ?><div class="x_alert x_alert-block">
	<p><?php echo $lang->faceoff_migration[0] ?></p>
	<p><a href="#faceoff_migration_info" class="modalAnchor"><?php echo $lang->faceoff_migration[1] ?></a></p>
</div><?php } ?>
<?php if($__Context->layout == 'faceoff'){ ?><section id="faceoff_migration_info" class="x_modal">
	<div class="x_modal-header">
		<h1><?php echo $lang->faceoff_migration[1] ?></h1>
	</div>
	<div class="x_modal-body">
		<ol>
			<li>
				<p><?php echo $lang->faceoff_migration[2] ?></p>
			...
			<li>
				<p><?php echo $lang->faceoff_migration[3] ?></p>
			...
			<li>
				<p><?php echo $lang->faceoff_migration[4] ?></p>
				<img src="/modules/layout/tpl/faceoff_migration/03.png" alt="" />
			</li>
			<li>
				<p><?php echo $lang->faceoff_migration[5] ?></p>
			...
			<li>
				<p><?php echo $lang->faceoff_migration[6] ?></p>
	...
	<div class="x_modal-footer">
		<button type="button" class="x_btn x_pull-left" data-hide="#faceoff_migration_info"><?php echo $lang->cmd_close ?></button>
	</div>
</section><?php } ?>
<?php 
