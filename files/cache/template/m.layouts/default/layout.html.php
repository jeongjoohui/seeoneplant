<?php if(!defined("__XE__"))exit;?><!--#Meta:m.layouts/default/mx.css--><?php $__tmp=array('m.layouts/default/mx.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
<div class="hd">
...
if(!$__Context->layout_info->index_title && Context::getSiteTitle()){ ?> alt="<?php echo Context::getSiteTitle() ?>"<?php } ?> />
	...
	<?php if($__Context->layout_info->menu->main_menu->menu_srl){ ?>
		...
		<div class="fr"><button type="button" class="muon" onclick="history.back()"><?php echo $lang->cmd_back ?></button></div>
		<?php }else{ ?>
