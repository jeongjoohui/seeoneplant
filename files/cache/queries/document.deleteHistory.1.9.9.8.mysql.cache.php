...
new Table('`rx_document_histories`', '`document_histories`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`history_srl`',$history_srl5_argument,"equal", 'and')
,new ConditionWithArgument('`document_srl`',$document_srl6_argument,"equal", 'and')
,new ConditionWithArgument('`module_srl`',$module_srl7_argument,"equal", 'and')),'and')
));
