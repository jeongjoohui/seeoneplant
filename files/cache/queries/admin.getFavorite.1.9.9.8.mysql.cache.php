...
new Table('`rx_admin_favorite`', '`admin_favorite`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`admin_favorite_srl`',$favorite_srl1_argument,"equal", 'and')
,new ConditionWithArgument('`site_srl`',$site_srl2_argument,"equal", 'and')
,new ConditionWithArgument('`module`',$module3_argument,"equal", 'and')),'and')
));
