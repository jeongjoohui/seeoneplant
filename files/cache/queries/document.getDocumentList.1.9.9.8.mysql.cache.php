...
${'member_srl33_argument'} = new ConditionArgument('member_srl', $args->member_srl, 'in');
...
${'s_user_name39_argument'} = new ConditionArgument('s_user_name', $args->s_user_name, 'like_prefix');
...
${'s_user_id40_argument'} = new ConditionArgument('s_user_id', $args->s_user_id, 'like_prefix');
...
${'s_nick_name41_argument'} = new ConditionArgument('s_nick_name', $args->s_nick_name, 'like_prefix');
...
new ConditionWithArgument('`module_srl`',$module_srl29_argument,"in", 'and')
...
,new ConditionWithArgument('`member_srl`',$member_srl33_argument,"in", 'and')
,new ConditionWithArgument('`status`',$statusList34_argument,"in", 'and')),'and')
,new ConditionGroup(array(
...
,new ConditionGroup(array(
new ConditionWithArgument('`title`',$s_title37_argument,"like", 'and')
,new ConditionWithArgument('`content`',$s_content38_argument,"like", 'or')
,new ConditionWithArgument('`user_name`',$s_user_name39_argument,"like_prefix", 'or')
,new ConditionWithArgument('`user_id`',$s_user_id40_argument,"like_prefix", 'or')
,new ConditionWithArgument('`nick_name`',$s_nick_name41_argument,"like_prefix", 'or')
