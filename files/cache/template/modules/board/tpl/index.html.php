...
echo $__Context->module_category[$__Context->val->module_category_srl]->title;
			...
			<td>
				<a href="<?php echo getUrl('act','dispBoardAdminBoardInfo','module_srl',$__Context->val->module_srl) ?>" class="x_icon-cog" title="<?php echo $lang->cmd_setup ?>"><?php echo $lang->cmd_setup ?></a>
				<a href="<?php echo getUrl('','module','module','act','dispModuleAdminCopyModule','module_srl',$__Context->val->module_srl) ?>" class="x_icon-plus" onclick="popopen(this.href);return false;" title="<?php echo $lang->cmd_copy ?>"><?php echo $lang->cmd_copy ?></a>
				<a href="<?php echo getUrl('act','dispBoardAdminDeleteBoard','module_srl', $__Context->val->module_srl) ?>" class="x_icon-remove" title="<?php echo $lang->cmd_delete ?>"><?php echo $lang->cmd_delete ?></a>
			</td>
