...
Context::addJsFile("modules/module/ruleset/insertModuleSetup.xml", FALSE, "", 0, "body", TRUE, "") ?><form  action="./" method="post" class="x_form-horizontal" id="manageSelectedModuleSetup"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="insertModuleSetup" />
	...
	<?php if(count($__Context->skin_list)){ ?><div class="x_control-group">
		...
		<div class="x_controls">
			<select name="skin" id="skin">
				<option value="" selected="selected"><?php echo $lang->keep_existing_value ?></option>
				<?php if($__Context->skin_list)foreach($__Context->skin_list as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->module_info->skin==$__Context->key){ ?> selected="selected"<?php } ?>><?php echo $__Context->val->title ?></option><?php } ?>
			</select>
	...
	<div class="x_control-group">
		...
		<div class="x_controls">
			<select name="mlayout_srl" id="mlayout_srl">
				<option value="" selected="selected"><?php echo $lang->keep_existing_value ?></option>
				<option value="0"><?php echo $lang->notuse ?></option>
				<?php if($__Context->mlayout_list)foreach($__Context->mlayout_list as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->val->layout_srl ?>"<?php if($__Context->module_info->mlayout_srl== $__Context->val->layout_srl){ ?> selected="selected"<?php } ?>><?php echo $__Context->val->title ?> (<?php echo $__Context->val->layout ?>)</option><?php } ?>
			</select>
		</div>
	</div>
	<div class="x_control-group">
		...
		<div class="x_controls">
			<select name="mskin" id="mskin">
				<option value="" selected="selected"><?php echo $lang->keep_existing_value ?></option>
				<?php if($__Context->mskin_list)foreach($__Context->mskin_list as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->module_info->mskin== $__Context->key){ ?> selected="selected"<?php } ?>><?php echo $__Context->val->title ?></option><?php } ?>
			</select>
		</div>
	</div>
	<div class="x_control-group">
		...
		<div class="x_controls">
			...
			<p class="x_help-inline"><?php echo $lang->about_description ?></p>
		</div>
	</div>
	<div class="x_control-group">
		...
		<div class="x_controls">
			...
			<p class="x_help-inline" style="vertical-align:top"><?php echo $lang->about_header_text ?></p>
		</div>
	</div>
	<div class="x_control-group">
		...
		<div class="x_controls">
			...
			<p class="x_help-inline" style="vertical-align:top"><?php echo $lang->about_footer_text ?></p>
		</div>
	</div>
	<div class="btnArea">
