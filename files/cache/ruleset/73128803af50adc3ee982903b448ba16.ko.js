...
v.cast('ADD_FILTER',['insertDefaultConfig', {'enable_join':{required:true},'password_strength':{required:true},'password_hashing_algorithm':{required:true},'password_hashing_work_factor':{required:true},'password_hashing_auto_upgrade':{required:true}}]);
