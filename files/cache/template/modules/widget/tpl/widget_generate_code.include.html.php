...
<div class="x_control-group">
	...
	<div class="x_controls">
		<select name="skin" id="skin">
			...
			<?php if($__Context->skin_list)foreach($__Context->skin_list as $__Context->skin_name=>$__Context->skin){ ?><option value="<?php echo $__Context->skin_name ?>"><?php echo $__Context->skin->title ?>(<?php echo $__Context->skin_name ?>)</option><?php } ?>
		</select>
...
<?php if($__Context->widget_info->extra_var)foreach($__Context->widget_info->extra_var as $__Context->id=>$__Context->var){ ?>
		...
		<div class="x_controls">
			...
			<?php if($__Context->var->type == 'select'){ ?>
				<select name="<?php echo $__Context->id ?>" id="<?php echo $__Context->id ?>">
					<?php if($__Context->var->options)foreach($__Context->var->options as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->key ?>"><?php echo $__Context->val ?></option><?php } ?>
				</select>
			<?php } ?>
...
if($__Context->var->init_options[$__Context->key]){ ?><option value="<?php echo $__Context->key ?>"<?php if($__Context->var->default_options[$__Context->key]){ ?> default="true"<?php } ?>><?php echo $__Context->val ?></option><?php }} ?>
			...
			<?php if($__Context->var->type == 'mid_list'){ ?>
				<?php if($__Context->mid_list)foreach($__Context->mid_list as $__Context->module_category_srl=>$__Context->modules){ ?><fieldset>
					...
					<?php } ?>
					<?php if($__Context->modules->list)foreach($__Context->modules->list as $__Context->key=>$__Context->val){ ?><div>
			...
			<?php if($__Context->var->type == 'menu'){ ?>
				<select name="<?php echo $__Context->id ?>">
					<option value="">-</option>
					<?php if($__Context->menu_list)foreach($__Context->menu_list as $__Context->key=>$__Context->val){ ?><option value="<?php echo $__Context->val->menu_srl ?>"><?php echo $__Context->val->title ?></option><?php } ?>
				</select>
			<?php } ?>
			<?php if($__Context->var->type == 'radio'){ ?>
				<?php if($__Context->var->options)foreach($__Context->var->options as $__Context->key=>$__Context->val){ ?><label>
