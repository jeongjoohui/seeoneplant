<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/default/board.default.css--><?php $__tmp=array('modules/board/skins/default/board.default.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
