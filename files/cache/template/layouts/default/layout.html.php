<?php if(!defined("__XE__"))exit;?><!--#Meta:layouts/default/default.layout.css--><?php $__tmp=array('layouts/default/default.layout.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
<?php if($__Context->layout_info->WEB_FONT == 'YES'){ ?><!--#Meta:layouts/default/default.layout.webfont.css--><?php $__tmp=array('layouts/default/default.layout.webfont.css','','','',array());Context::loadFile($__tmp);unset($__tmp);
} ?>
	...
	<header class="header">
		<h1>
			<a href="<?php echo geturl('') ?>" id="siteTitle">
				<?php if(!Context::getSiteTitle() && !$__Context->layout_info->LOGO_IMG && !$__Context->layout_info->LOGO_TEXT){ ?><img src="/layouts/default/siteTitle.png" alt="Rhymix"><?php } ?>
...
echo $__Context->layout_info->LOGO_TEXT;
		...
		<nav class="gnb" id="gnb">
			<ul>
				<?php if($__Context->GNB->list)foreach($__Context->GNB->list as $__Context->key1=>$__Context->val1){ ?><li<?php if($__Context->val1['selected']){ ?> class="active"<?php } ?>>
