...
<form action="./" method="post" onsubmit="return procFilter(this, window.insert)" class="board_write"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<div class="write_header">
		...
		<?php if($__Context->grant->manager){ ?><label for="is_notice"><?php echo $lang->notice ?></label><?php } ?>
	</div>
	...
	<div class="write_footer">
		<div class="write_option">
			...
			<?php } ?>
			<input type="checkbox" name="comment_status" class="iCheck" value="ALLOW" checked="checked" |cond="$__Context->oDocument->allowComment()" id="comment_status" />
			<label for="comment_status"><?php echo $lang->allow_comment ?></label>
			<input type="checkbox" name="allow_trackback" class="iCheck" value="Y" checked="checked" |cond="$__Context->oDocument->allowTrackback()" id="allow_trackback" />
		...
		<?php if($__Context->captcha){ ?><div class="write_captcha">
