<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/board/skins/xedition/board.default.css--><?php $__tmp=array('modules/board/skins/xedition/board.default.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
