...
new ConditionWithArgument('`module_part_config`.`module`',$module1_argument,"equal", 'and')
,new ConditionWithoutArgument('`modules`.`module_srl`','`module_part_config`.`module_srl`',"equal", 'and')
,new ConditionWithArgument('`modules`.`site_srl`',$site_srl2_argument,"equal", 'and')),'and')
));
