...
$query = new Query();
$query->setQueryId("getDocumentDeclaredLogInfo");
...
new Table('`rx_document_declared_log`', '`document_declared_log`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`document_srl`',$document_srl1_argument,"equal", 'and')),'and')
,new ConditionGroup(array(
