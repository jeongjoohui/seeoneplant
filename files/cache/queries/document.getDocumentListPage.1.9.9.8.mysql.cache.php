...
${'member_srl5_argument'} = new ConditionArgument('member_srl', $args->member_srl, 'in');
...
${'s_user_name11_argument'} = new ConditionArgument('s_user_name', $args->s_user_name, 'like_prefix');
...
${'s_user_id12_argument'} = new ConditionArgument('s_user_id', $args->s_user_id, 'like_prefix');
...
${'s_nick_name13_argument'} = new ConditionArgument('s_nick_name', $args->s_nick_name, 'like_prefix');
...
new ConditionWithArgument('`module_srl`',$module_srl1_argument,"in", 'and')
...
,new ConditionWithArgument('`member_srl`',$member_srl5_argument,"in", 'and')
,new ConditionWithArgument('`status`',$statusList6_argument,"in", 'and')),'and')
,new ConditionGroup(array(
...
,new ConditionGroup(array(
new ConditionWithArgument('`title`',$s_title9_argument,"like", 'and')
,new ConditionWithArgument('`content`',$s_content10_argument,"like", 'or')
,new ConditionWithArgument('`user_name`',$s_user_name11_argument,"like_prefix", 'or')
,new ConditionWithArgument('`user_id`',$s_user_id12_argument,"like_prefix", 'or')
,new ConditionWithArgument('`nick_name`',$s_nick_name13_argument,"like_prefix", 'or')
