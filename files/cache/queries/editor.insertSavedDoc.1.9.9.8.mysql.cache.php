...
${'certify_key7_argument'} = new Argument('certify_key', $args->{'certify_key'});
if(!${'certify_key7_argument'}->isValid()) return ${'certify_key7_argument'}->getErrorMessage();
} else
${'certify_key7_argument'} = NULL;if(${'certify_key7_argument'} !== null) ${'certify_key7_argument'}->setColumnType('varchar');

${'regdate8_argument'} = new Argument('regdate', $args->{'regdate'});
${'regdate8_argument'}->ensureDefaultValue(getInternalDateTime());
...
,new InsertExpression('`certify_key`', ${'certify_key7_argument'})
