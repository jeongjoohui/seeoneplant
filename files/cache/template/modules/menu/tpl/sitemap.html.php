<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/menu/tpl/css/sitemap.css--><?php $__tmp=array('modules/menu/tpl/css/sitemap.css','','','11',array());Context::loadFile($__tmp);unset($__tmp); ?>
...
<div class="_quick_help x_alert">
	...
	<label><input class="_quick_help_nomore" type="checkbox"/> <?php echo $lang->do_not_display_again ?></label>
</div>
...
<?php if($__Context->act == 'dispMenuAdminSiteMap'){ ?>
	<div class="col map" id="site_map">
		<h1><?php echo $lang->menu_gnb_sub['siteMap'] ?></h1>
		<form id="menu_find"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
			<input name="keyword" type="text"></input>
			<button class="x_btn x_btn-inverse btn-find"><?php echo $lang->cmd_find ?></button>
			<button class="x_btn x_btn-inverse btn-next" type="button"><?php echo $lang->cmd_next ?></button>
		</form>
		<div class="cnt">
			...
			<button type="button" class="x_btn x_btn-link _addSiteMap1" data-admin-show="#add_sitemap" style="position:absolute;right:5px;bottom:7px;color:#000"><i class="x_icon-plus-sign"></i> <?php echo $lang->add_new_sitemap ?></button>
		</div>
	</div>
	<div class="col" id="add_sitemap" style="display:none">
		<section>
			<h1>
				<?php echo $lang->add_new_sitemap ?>
			</h1>
			<div class="cnt">
				<ul class="_itemList">
					<li>
						<label for="sitemapName"><?php echo $lang->sitemap_name ?></label>
						<input id="sitemapName" class="_sitemapName" type="text" required>
					</li>
				</ul>
				<div class="btnBoth">
					<button type="reset" class="x_btn x_pull-left" data-admin-hide="#sitemap_general"><?php echo $lang->cmd_cancel ?></button>
					<button type="button" class="x_btn x_btn-primary x_pull-right _save"><?php echo $lang->cmd_confirm ?></button>
				</div>
			</div>
		</section>
	...
	<div class="col" id="propertiesRoot" style="display:none">
		<section>
			...
			<div class="cnt">
				<ul class="nav">
					<li><a href="#sitemap_general" data-admin-show="#sitemap_general"><?php echo $lang->edit_sitemap ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li><a href="#add" data-admin-show="#add"><?php echo $lang->add_menu ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li><button type="button"  class="_edit_paste" disabled><?php echo $lang->paste ?></button></li>
					<li><button class="_delSiteMap" type="button"><?php echo $lang->cmd_delete ?></button></li>
					<li><button class="_renameSiteMap" type="button"><?php echo $lang->change_name ?></button></li>
				</ul>
			</div>
		</section>
	...
	<div class="col" id="sitemap_general" style="display:none">
		<section>
			<h1><?php echo $lang->edit_sitemap ?></h1>
			<div class="cnt">
				<ul class="_itemList">
					<li>
						<label for="sitemapName2"><?php echo $lang->sitemap_name ?></label>
	...
	<div class="col prop-general" id="properties" style="display:none;">
		<section>
			...
			<div class="cnt">
				<ul>
					<li class="type"><strong><?php echo $lang->menu_type ?></strong>: <span class="module_type"></span></li>
					<li><a href="#default" data-admin-show="#default"><?php echo $lang->general_settings ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<!--li><strong><?php echo $lang->menu_id ?></strong>: <span class="url"></span></li-->
					<li><a href="#add" data-admin-show="#add"><?php echo $lang->add_menu ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li><button type="button" class="_edit_cut"><?php echo $lang->cut ?></button></li>
					<li class="ex"><button type="button" class="_edit_copy"><?php echo $lang->copy ?></button></li>
					<li class="ex"><button type="button" class="_edit_paste" disabled><?php echo $lang->paste ?></button></li>
					<li class="ex"><button type="button" class="_deleteMenu"><?php echo $lang->cmd_delete ?></button></li>
					<li><a href="#imgbtn" data-admin-show="#imgbtn"><?php echo $lang->menu_img_btn ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li class="design"><a href="#design" data-admin-show="#design"><?php echo $lang->design ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li><a href="#auth" data-admin-show="#auth"><?php echo $lang->grant ?> <i class="x_icon-circle-arrow-right"></i></a></li>
					<li class="_hasFullSetupX details"><a href="#" class="_openFullSetup"><?php echo $lang->full_settings ?> <i class="x_icon-cog"></i></a></li>
					<li class="_hasFullSetupO details"><a href="#fullSetup" data-admin-show="#fullSetup"><?php echo $lang->full_settings ?> <i class="x_icon-circle-arrow-right"></i></a></li>
				</ul>
			</div>
		</section>
	...
	<div class="col" id="add" style="display:none">
		<section>
			...
			<div class="cnt">
				...
				<a href="#download" class="x_btn x_btn-link" data-admin-show="#download" style="position:absolute;right:5px;bottom:7px;color:#000"><i class="x_icon-plus-sign"></i> <?php echo $lang->install_other_menu_types ?></a>
			</div>
		</section>
	...
	<div class="col url" id="add_menu" style="display:none">
		<fieldset>
			<h1 class="_title"></h1>
			<div class="cnt">
				<p class="desc"><dfn class="_description"></dfn> <a class='_link'><i class="xi-link"></i><?php echo $lang->details ?></a></p>
				<ul>
					<li>
						<div class="multilingual x_input-append">
							<label for="lang_menuName2"><?php echo $lang->menu_name ?></label>
							<input id="menuName2" class="_menuName lang_code" type="text" required>
						</div>
					</li>
					<li>
						<div class="multilingual x_input-append">
							<label for="lang_menuDesc2"><?php echo $lang->menu_desc ?></label>
							<input id="menuDesc2" class="_menuDesc lang_code" type="text" required>
						</div>
					</li>
					<li class="typePage">
						<label for="mid1"><?php echo $lang->menu_id ?> <a href="#help_menuId" class="x_icon-question-sign" data-admin-toggle="#mid1_help"><?php echo $lang->help ?></a></label>
						<div id="mid1_help" class="x_alert x_alert-info">
							<button type="button" class="x_close" data-admin-hide="#mid1_help">×</button>
							<p><?php echo $lang->about_menu_id ?> <?php echo $lang->about_new_menu_id ?></p>
						</div>
						<input id="mid1" class="_mid" type="text" required placeholder="<?php echo $lang->skip_menu_id ?>" />
					</li>
					<li class="typeUrl">
						<div class="x_tabbable">
							<ul class="x_nav x_nav-tabs">
								<li class="x_active"><a href="#add_linkUrl"><?php echo $lang->url_link ?></a></li>
								<li><a href="#add_linkMenu"><?php echo $lang->menu_link ?></a></li>
							</ul>
							<div class="x_tab-content">
								<div class="x_tab-pane x_active" id="add_linkUrl">
									<input type="url" class="_linkUrl" required="required" title="<?php echo $lang->url_link ?>" placeholder="http://" />
								</div>
								<div class="x_tab-pane" id="add_linkMenu">
									<input type="text" class="_linkMenuTitle" title="<?php echo $lang->menu_link ?>" disabled placeholder="<?php echo $lang->about_menu_link ?>" />
				...
				<div class="x_btn-group">
					<button type="button" class="x_btn x_btn-primary _save"><?php echo $lang->cmd_confirm ?></button>
				</div>
			</div>
		</fieldset>
	...
	<div class="col download" id="download" style="display:none">
		<section>
			<h1><?php echo $lang->install_other_menu_types ?></h1>
			<div class="cnt">
				<div class="list">
				</div>
		...
		<fieldset>
			...
			<div class="cnt">
				<ul>
					<li>
						<div class="multilingual x_input-append">
							<label for="lang_menuName"><?php echo $lang->menu_name ?></label>
							<input id="menuName" class="_menuName lang_code" type="text" required>
						</div>
					</li>
					<li>
						<div class="multilingual x_input-append">
							<label for="lang_menuDesc"><?php echo $lang->menu_desc ?></label>
							<input id="menuDesc" class="_menuDesc lang_code" type="text" required>
						</div>
					</li>
					<li style="padding:6px 0 0 0">
						<label><input type="checkbox" class="_newWindow" title="<?php echo $lang->menu_open_window ?>"> <?php echo $lang->menu_open_window ?></label>
					</li>
					<li style="padding:0 0 6px 0">
						<label><input type="checkbox" class="_leaveUnfolded" title="<?php echo $lang->menu_expand ?>"> <?php echo $lang->menu_expand ?></label>
					</li>
					<li class="typePage" style="border-top:1px solid #DDD">
						<label for="lang_pageTitle"><?php echo $lang->browser_title ?> <a href="#help_menuName" class="x_icon-question-sign" data-admin-toggle="#help_menuName"><?php echo $lang->help ?></a></label>
						<div id="help_menuName" class="x_alert x_alert-info">
							<button type="button" class="x_close" data-admin-hide="#help_menuName">×</button>
							<p><?php echo $lang->about_browser_title ?></p>
						</div>
						<input id="pageTitle" class="_browserTitle lang_code" type="text">
						<label for="mid2"><?php echo $lang->menu_id ?> <a href="#help_menuId" class="x_icon-question-sign" data-admin-toggle="#mid2_help"><?php echo $lang->help ?></a></label>
						<div id="mid2_help" class="x_alert x_alert-info">
							<button type="button" class="x_close" data-admin-hide="#mid2_help">×</button>
							<p><?php echo $lang->about_menu_id ?></p>
						</div>
					...
					<li class="typeUrl">
						<div class="x_tabbable">
							<ul class="x_nav x_nav-tabs">
								<li class="x_active"><a href="#fix_linkUrl"><?php echo $lang->url_link ?></a></li>
								<li><a href="#fix_linkMenu"><?php echo $lang->menu_link ?></a></li>
							</ul>
							<div class="x_tab-content">
								<div class="x_tab-pane x_active" id="fix_linkUrl">
									<input type="text" class="_url_link" title="<?php echo $lang->url_link ?>" />
								</div>
					...
					<li>
						<p id="menuTypeHelpInDefault" style="width:220px;min-width:100%"><?php echo $lang->about_menu_type_in_default ?></p>
					</li>
				</ul>
				<div class="btnBoth">
					<button type="reset" class="x_btn x_pull-left" data-admin-hide="#default"><?php echo $lang->cmd_cancel ?></button>
					<button type="button" class="x_btn x_btn-primary x_pull-right _save"><?php echo $lang->cmd_confirm ?></button>
				</div>
			</div>
		</fieldset>
	...
	<div class="col" id="imgbtn" style="display:none">
		<fieldset>
			<h1><?php echo $lang->menu_img_btn ?></h1>
			<div class="cnt">
				<p style="border-bottom:1px solid #ddd;width:220px;min-width:100%;padding-bottom:10px"><?php echo $lang->about_imgbtn ?></p>
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_normal" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					...
					<figure>
						<figcaption><?php echo $lang->menu_normal_btn ?></figcaption>
						<p class="noImg"><?php echo $lang->menu_no_img_btn ?></p>
						<img class="_thumbnail" src="/common/img/blank.gif" alt="<?php echo $lang->about_menu_normal_btn ?>">
					</figure>
					<div class="btnBoth">
						<button type="submit" class="delete x_btn x_pull-left"><?php echo $lang->cmd_delete ?></button>
						<span class="fileBtn x_btn x_pull-right">
							<span class="modify"><?php echo $lang->menu_change_btn ?></span>
							<span class="upload"><?php echo $lang->menu_upload_btn ?></span>
							<input type="file" title="<?php echo $lang->menu_change_btn ?>/<?php echo $lang->menu_upload_btn ?>" name="menu_normal_btn">
						</span>
					</div>
				</form>
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_hover" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					...
					<figure>
						<figcaption><?php echo $lang->menu_hover_btn ?></figcaption>
						<p class="noImg"><?php echo $lang->menu_no_img_btn ?></p>
						<img class="_thumbnail" src="/common/img/blank.gif" alt="<?php echo $lang->about_menu_hover_btn ?>">
					</figure>
					<div class="btnBoth">
						<button type="submit" class="delete x_btn x_pull-left"><?php echo $lang->cmd_delete ?></button>
						<span class="fileBtn x_btn x_pull-right">
							<span class="modify"><?php echo $lang->menu_change_btn ?></span>
							<span class="upload"><?php echo $lang->menu_upload_btn ?></span>
							<input type="file" title="<?php echo $lang->menu_change_btn ?>/<?php echo $lang->menu_upload_btn ?>" name="menu_hover_btn">
						</span>
					</div>
				</form>
				<form action="?module=menu&act=procMenuAdminButtonUpload" class="_btn_selected" target="submitTarget" method="post" enctype="multipart/form-data"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					...
					<figure>
						<figcaption><?php echo $lang->menu_active_btn ?></figcaption>
						<p class="noImg"><?php echo $lang->menu_no_img_btn ?></p>
						<img class="_thumbnail" src="/common/img/blank.gif" alt="<?php echo $lang->about_menu_active_btn ?>">
					</figure>
					<div class="btnBoth">
						<button type="submit" class="delete x_btn x_pull-left"><?php echo $lang->cmd_delete ?></button>
						<span class="fileBtn x_btn x_pull-right">
							<span class="modify"><?php echo $lang->menu_change_btn ?></span>
							<span class="upload"><?php echo $lang->menu_upload_btn ?></span>
							<input type="file" title="<?php echo $lang->menu_change_btn ?>/<?php echo $lang->menu_upload_btn ?>" name="menu_active_btn">
						</span>
					</div>
				</form>
			</div>
	...
	<?php } ?>
		<fieldset>
			<h1 class="_item"><?php echo $lang->design ?></h1>
			<h1 class="_site"><?php echo $lang->menu_gnb_sub['siteDesign'] ?></h1>
			<div class="cnt">
				<form action="./" target="xe_preview" class="_preview_form" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					<input type="hidden" name="skin_vars" value="{}"/>
					<div class="x_tabbable">
						<ul class="x_nav x_nav-tabs">
							<li class="x_active"><a href="#pc">PC</a></li>
							<li><a href="#mobile"><?php echo $lang->mobile ?></a></li>
						</ul>
						<div class="x_tab-content">
							<div class="x_tab-pane x_active" id="pc">
								<div class="shadow">
									<iframe name="_pc_preview_ifr" src="about:_blank"></iframe><i class="mask"><span></span></i>
									<input type="submit" class="x_icon-zoom-in x_icon-white _pc_preview_open" value="<?php echo $lang->view_zoom ?>" />
								</div>
							</div>
							<div class="x_tab-pane" id="mobile">
								<label class="mvOption"><input type="checkbox" name="use_mobile" value="Y"> <?php echo $lang->use_mobile_view ?></label>
								<div class="shadow">
									<iframe name="_mobile_preview_ifr" src="about:_blank"></iframe><i class="mask"><span></span></i>
									<input type="submit" class="x_icon-zoom-in x_icon-white _mobile_preview_open" value="<?php echo $lang->view_zoom ?>" />
								</div>
							</div>
						</div>
					</div>
				...
				<ul class="nav _itemList">
					...
					<li><a href="#layout" data-admin-show="#layout"><?php echo $lang->layout ?> [<span class="themeName _layoutName">${LayoutName}</span>] <i class="x_icon-circle-arrow-right"></i></a></li>
					</script>
					<script id="tmpl_skinItem" type="text/x-jquery-tmpl">
					<li><a href="#skin" data-admin-show="#skin" data-param='{ "moduleType" : "${ModuleType}"}'>${ModuleTypeTitle} [<span class="themeName _skinTitle">{{if SkinTitle}}${SkinTitle}{{else}}<?php echo $lang->no_skin ?>{{/if}}</span>] <i class="x_icon-circle-arrow-right"></i></a></li>
					</script>
				</ul>
				<div class="btnBoth siteDesignUI">
					<button type="reset" class="x_btn x_pull-left _btn_cancel"><?php echo $lang->cmd_cancel ?></button>
					<button type="button" class="x_btn x_btn-primary x_pull-right _btn_save">
						<span class="langDesktop"><?php echo $lang->desktop_settings ?></span>
						<span class="langMobile"><?php echo $lang->mobile_settings ?></span>
						<?php echo $lang->cmd_save ?>
					</button>
				</div>
			</div>
		</fieldset>
	...
	<div class="col theme" id="layout" style="display:none">
		<form action=""><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
			<h1><?php echo $lang->layout ?></h1>
			<div class="cnt">
				<label style="white-space:nowrap;cursor:pointer;width:100%">
					<?php echo $lang->use_site_design ?><input type="checkbox" class="_chkUseDefaultLayout switch" title="<?php echo $lang->use_site_default_layout ?>"><i style="float:right"></i>
				</label>
				<div class="list">
					<ul class="_layout_list">
						...
						<li class="${Selected} _layoutItem">
							<label>
								<input type="radio" name="layout_item" title="<?php echo $lang->no_use_layout ?>"><i></i> <?php echo $lang->no_use_layout ?>
							</label>
						</li>
						</script>
						<script id="tmpl_layout_list_item_add_new" type="text/x-jquery-tmpl">
						<li data-admin-show="#downloadLayout">
							<label><i class="x_icon-plus-sign"></i> <?php echo $lang->install_other_layouts ?></label>
							<button type="button" class="item _btnScreenshot">
								<img src="/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $lang->install_other_layouts ?>">
							</button>
						</li>
						</script>
						...
						<li class="${Selected} _layoutItem">
							...
							<button type="button" class="item _btnScreenshot" title="<?php echo $lang->about_apply_layout ?>">
								<img src="${ScreenShotURL}" class="_thumbnail" alt="${Title}">
							</button>
							<ul class="_edit_menu">
								<li><a href="#layoutSetup" data-admin-show="#layoutSetup" data-param='{ "sLayoutSrl":"${LayoutSrl}"}'><?php echo $lang->full_settings ?> <i class="x_icon-circle-arrow-right"></i></a></li>
								...
								<li><button type="button" class="_duplicateLayout"><?php echo $lang->make_copy ?></button></li>
								<li><button type="button" class="_deleteLayout"><?php echo $lang->cmd_delete ?></button></li>
							</ul>
						</li>
						</script>
					</ul>
				...
				<div class="x_btn-group siteMapUI">
					<button type="button" class="x_btn x_btn-primary x_pull-right _save"><?php echo $lang->cmd_save ?></button>
				</div>
			</div>
		</form>
	...
	<div class="col layoutSetup" id="layoutSetup" style="display:none">
		<section>
			<h1><?php echo $lang->layout_settings ?></h1>
			<div class="cnt">
	...
	<div class="col layoutMarkupSetup" id="layoutMarkupSetup" style="display:none">
		<section>
			<h1><?php echo $lang->layout_html_css_settings ?></h1>
			<div class="cnt">
				<div class="_contents"></div>
			</div>
		</section>
	...
	<div class="col download" id="downloadLayout" style="display:none">
		<section>
			<h1><?php echo $lang->install_other_layouts ?></h1>
			<div class="cnt">
				<div class="list">
				</div>
				...
				<div class="search x_input-append x_pull-right">
					...
					<button class="x_btn x_btn-inverse _search"><?php echo $lang->cmd_search ?></button>
					<a class="x_btn _cancel" href="#"><?php echo $lang->cmd_cancel ?></a>
				</div>
				</script>
	...
	<div class="col theme" id="skin" style="display:none">
		<form action=""><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
			<h1><?php echo $lang->skin ?></h1>
			<div class="cnt">
				<label style="cursor:pointer">
					<?php echo $lang->use_site_design ?>
					<input type="checkbox" class="_chkUseDefault switch" title="<?php echo $lang->use_site_default_skin ?>">
				...
				<div class="list">
					<ul class="_list">
						...
						<li class="_item ${Selected}">
							<label>
								<input type="radio" name="skin_item" title="스킨 사용 안 함"> <?php echo lang('menu.no_use_layout') ?>
							</label>
						</li>
						</script>
						<script id="tmpl_skin_list_item_add_new" type="text/x-jquery-tmpl">
						<li data-admin-show="#downloadSkin">
							<label><i class="x_icon-plus-sign"></i> <?php echo $lang->install_other_skins ?></label>
							<button type="button" class="item _btnScreenshot">
								<img src="/modules/layout/tpl/img/download.png" class="_thumbnail" alt="<?php echo $lang->install_other_skins ?>">
							</button>
						</li>
						</script>
						...
						<li class="_item ${Selected}">
							...
							<button type="button" class="item _btnScreenshot" title="<?php echo $lang->about_apply_skin ?>">
								<img src="${ScreenShotURL}">
							</button>
							<!--
							<ul>
								<li><a href="#skinSetup" data-admin-show="#skinSetup" data-param='{ "sSkinName":"${SkinName}"}'><?php echo $lang->cmd_setup ?> <i class="x_icon-circle-arrow-right"></i></a></li>
							</ul>
							-->
						</li>
						</script>
					...
					<i class="mask"></i>
					<!--
					<a href="#downloadSkin" data-admin-show="#downloadSkin" class="x_btn x_btn-link" style="position:absolute;right:5px;bottom:7px;color:#000"><i class="x_icon-plus-sign"></i> <?php echo $lang->install_other_skins ?></a>
					-->
				</div>
				<div class="x_btn-group siteMapUI">
					<button type="button" class="x_btn x_btn-primary x_pull-right _save"><?php echo $lang->cmd_save ?></button>
	...
	<div class="col skinSetup" id="skinSetup" style="display:none">
		<section>
			<h1><?php echo lang('menu.skin_settings') ?></h1>
			<div class="cnt">
				<div class="_contents"></div>
			</div>
		</section>
	...
	<div class="col download" id="downloadSkin" style="display:none">
		<section>
			<h1><?php echo $lang->install_other_skins ?></h1>
			<div class="cnt">
				<div class="list">
					<script id="tmpl_noDownloadableItem" type="text/x-jquery-tmpl">
						<p style="margin:15px 0"><?php echo $lang->no_downloadable_item ?></p>
					</script>
					<script id="tmpl_downloadableItem" type="text/x-jquery-tmpl">
						<div class="item ${IsInstalled} ${IsUpToDate}">
							...
							<p>${MenuTypeDesc}</p>
							<p><i class="starRating score${Score}"><i></i></i> <b class="x_badge">${Score}/${TotalVotes}</b> <?php echo $lang->package_update ?>: <time title="${LastUpdatedWithTime}">${LastUpdated}</time> <i>|</i> <?php echo $lang->package_downloaded_count ?>: ${TotalDownloads}</p>
							<div class="_install">
								<button type="button" class="x_icon-download-alt x_icon-white _install_this"><?php echo $lang->install ?></button>
							</div>
							<div class="_already_installed">
								<div class="_already_up_to_date">
									<button type="button" class="done"><i class="x_icon-ok-sign x_icon-white"></i> <?php echo $lang->installed ?></button>
								</div>
								<div class="_need_to_update">
									<button type="button" class="update _install_this"><i class="x_icon-refresh x_icon-white"></i> <?php echo $lang->update ?></button>
								</div>
							</div>
						</div>
					</script>
				...
				<ul class="_list">
					...
					<li>
						...
						<select id="auth${PermId}">
							<option class="_group_all" value="0"><?php echo $lang->grant_to_all ?></option>
							<option class="_group_loggedin" value="-1"><?php echo $lang->grant_to_login_user ?></option>
							<option class="_group_manager" value="-3"><?php echo $lang->grant_to_admin ?></option>
							<option class="_group_selected" value="-10"><?php echo $lang->grant_to_group ?></option>
						</select>
	...
	<div class="col" id="fullSetup" style="display:none">
		<fieldset>
			<h1><?php echo $lang->full_settings ?></h1>
...
<script>
	xe.lang.shortcut = '<?php echo $lang->shortcut ?>';
	xe.lang.msg_no_root = xe.msg_no_root = "<?php echo $lang->msg_no_root ?>";
	xe.lang.msg_no_shortcut = xe.msg_no_shortcut = "<?php echo $lang->msg_no_shortcut ?>";
	xe.lang.msg_target_is_sub_of_origin = '<?php echo $lang->msg_target_is_sub_of_origin ?>';
	xe.lang.confirm_sitemap_delete = '<?php echo $lang->confirm_sitemap_delete ?>';
	xe.lang.confirm_menu_delete = '<?php echo $lang->confirm_menu_delete ?>';
	xe.lang.confirm_delete_all_contents = '<?php echo $lang->confirm_delete_all_contents ?>';
	xe.lang.confirm_shortcut_delete = '<?php echo $lang->confirm_shortcut_delete ?>';
	xe.lang.confirm_shortcut_desc = '<?php echo $lang->confirm_shortcut_desc ?>';
	xe.lang.confirm_delete_all_item = '<?php echo $lang->confirm_delete_all_item ?>';
	xe.lang.confirm_delete_all_sub_items_title = '<?php echo $lang->confirm_delete_all_sub_items_title ?>';
	xe.lang.confirm_delete_all_sub_items = '<?php echo $lang->confirm_delete_all_sub_items ?>';
	xe.lang.target_of_view_menu = '<?php echo $lang->target_of_view_menu ?>';
	xe.lang.success_saved = '<?php echo $lang->success_saved ?>';
	xe.lang.first_page = '<?php echo $lang->first_page ?>';
	xe.lang.last_page = '<?php echo $lang->last_page ?>';
	xe.lang.cmd_go_to_page = '<?php echo $lang->cmd_go_to_page ?>';
	xe.lang.input_new_layout_name = '<?php echo $lang->input_new_layout_name ?>';
	xe.lang.skip_new_layout_name = '<?php echo $lang->skip_new_layout_name ?>';
	xe.lang.confirm_delete = '<?php echo $lang->confirm_delete ?>';
	xe.lang.need_to_ftp_setup = '<?php echo $lang->need_to_ftp_setup ?>';
	xe.lang.go_to_ftp_setup = '<?php echo $lang->go_to_ftp_setup ?>';
	xe.lang.installation_completed = '<?php echo $lang->installation_completed ?>';
	xe.lang.go_to_site_design_setup = '<?php echo $lang->go_to_site_design_setup ?>';
	xe.lang.how_to_modify_menu = '<?php echo $lang->how_to_modify_menu ?>';
	xe.lang.can_drag_menu = '<?php echo $lang->can_drag_menu ?>';
	xe.lang.good_to_duplicate_layout = '<?php echo $lang->good_to_duplicate_layout ?>';
	xe.lang.img_uploaded = '<?php echo $lang->img_uploaded ?>';
	xe.lang.img_deleted = '<?php echo $lang->img_deleted ?>';
	xe.lang.no_use_layout = '<?php echo $lang->no_use_layout ?>';
	xe.lang.shortcut_desc = '<?php echo $lang->shortcut_desc ?>';
	xe.lang.msg_cannot_delete_homemenu = '<?php echo $lang->msg_cannot_delete_homemenu ?>';
	xe.lang.set_as_homepage = '<?php echo $lang->set_as_homepage ?>';
	xe.lang.has_been_set_as_homepage = '<?php echo $lang->has_been_set_as_homepage ?>';
	xe.lang.need_ftp_password = '<?php echo $lang->need_ftp_password ?>';
	xe.lang.need_ftp_password_title = '<?php echo $lang->need_ftp_password_title ?>';
	xe.lang.need_core_update = '<?php echo $lang->need_core_update ?>';
	xe.lang.need_core_update_continue = '<?php echo $lang->need_core_update_continue ?>';
	xe.lang.password = '<?php echo $lang->password ?>';
	xe.lang.not_found_module = '<?php echo $lang->not_found_module ?>';
</script>
<!--[if IE 7]>
<script>
jQuery(function($){
...
//-----------------------------------
	...
	function updateSelectedDesign(htDesign){
		...
		*/
		...
		if(!sSkinTitle){
			sSkinTitle = '<?php echo $lang->no_skin ?>';
		}
