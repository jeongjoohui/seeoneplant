...
${'layout_type4_argument'} = new ConditionArgument('layout_type', $args->layout_type, 'in');
...
${'layout5_argument'} = new ConditionArgument('layout', $args->layout, 'equal');
${'layout5_argument'}->createConditionValue();
if(!${'layout5_argument'}->isValid()) return ${'layout5_argument'}->getErrorMessage();
} else
${'layout5_argument'} = NULL;if(${'layout5_argument'} !== null) ${'layout5_argument'}->setColumnType('varchar');
...
,new ConditionWithArgument('`layout_type`',$layout_type4_argument,"in", 'and')
,new ConditionWithArgument('`layout`',$layout5_argument,"equal", 'and')),'and')
));
