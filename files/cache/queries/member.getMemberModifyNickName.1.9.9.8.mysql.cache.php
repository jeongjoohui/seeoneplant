...
$query = new Query();
$query->setQueryId("getMemberModifyNickName");
...
new Table('`rx_member_nickname_log`', '`member_nickname_log`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`member_srl`',$member_srl1_argument,"equal", 'and')),'and')
));
