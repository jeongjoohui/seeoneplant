function uninstall_package(form){ return legacy_filter('uninstall_package', form, 'autoinstall', 'procAutoinstallAdminUninstallPackage', completeUninstall, ['error','message'], '삭제하시겠습니까?', {}) };
(function($){
	var v=xe.getApp('validator')[0];if(!v)return false;
	v.cast("ADD_FILTER", ["uninstall_package", {'ftp_password': {required:true}}]);
	
	v.cast('ADD_MESSAGE',['ftp_password','FTP 비밀번호']);
