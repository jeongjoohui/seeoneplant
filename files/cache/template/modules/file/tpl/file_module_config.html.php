<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/file/tpl/css/config.css--><?php $__tmp=array('modules/file/tpl/css/config.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/file/tpl/js/config.js--><?php $__tmp=array('modules/file/tpl/js/config.js','','','');Context::loadFile($__tmp);unset($__tmp); ?>
<section class="section">
	<h1><?php echo $lang->file ?></h1>
	<?php Context::addJsFile("modules/file/ruleset/fileModuleConfig.xml", FALSE, "", 0, "body", TRUE, "") ?><form  action="./" method="post" class="x_form-horizontal"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="fileModuleConfig" />
