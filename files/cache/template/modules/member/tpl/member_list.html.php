<?php if(!defined("__XE__"))exit;?><!--#Meta:modules/member/tpl/css/member.css--><?php $__tmp=array('modules/member/tpl/css/member.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
<!--#Meta:modules/member/tpl/js/member_admin_list.js--><?php $__tmp=array('modules/member/tpl/js/member_admin_list.js','body','','');Context::loadFile($__tmp);unset($__tmp); ?>
<script>
...
<form action="" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="act" value="<?php echo $__Context->act ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
...
if($__Context->filter_type=='disable'){ ?>(<?php echo $__Context->total_count ?>)<?php } ?></a>
		...
		<thead>
			<tr>
				...
				<?php if($__Context->usedIdentifiers)foreach($__Context->usedIdentifiers as $__Context->name=>$__Context->title){ ?><th scope="col" class="nowr"><?php echo $__Context->title ?></th><?php } ?>
...
<section class="x_modal" id="listManager">
	<?php Context::addJsFile("modules/member/ruleset/updateSeletecdMemberInfo.xml", FALSE, "", 0, "body", TRUE, "") ?><form action="./"  method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="updateSeletecdMemberInfo" />
