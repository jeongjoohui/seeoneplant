...
<form action="./" class="x_form-horizontal" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<div class="x_control-group">
		<label class="x_control-label" for="manage_email_host"><?php echo $lang->cmd_manage_email_host ?>[<a href="#helpHost" data-toggle>?</a>]</label>
		<div class="x_controls">
			<div class="layer x_alert x_alert-info" id="helpHost">
				<p><?php echo $lang->about_emailhost_check ?></p>
			</div>
			...
			<p><?php  if($__Context->config->emailhost_check =='prohibited') $__Context->emailhost_check = $lang->cmd_prohibited; else $__Context->emailhost_check = $lang->cmd_allowed;
echo sprintf($lang->count_manage_email_host, count($__Context->managedEmailHost), $__Context->emailhost_check) ?></p>
	...
	<div class="x_control-group">
		...
		<div class="x_controls">
			...
			<p class="x_help-inline"><?php echo $lang->about_redirect_url ?></p>
		</div>
	</div>
	<div class="x_control-group">
...
<?php Context::addJsFile("modules/member/ruleset/insertJoinForm.xml", FALSE, "", 0, "body", TRUE, "") ?><form action="./" class="x_modal" id="userDefine"  method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="insertJoinForm" />
	<input type="hidden" name="module" value="member" />
