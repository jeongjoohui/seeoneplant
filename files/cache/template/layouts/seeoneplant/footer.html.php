<?php if(!defined("__XE__"))exit;?><footer class="main-footer" id="footer">
    <div class="container">
        ...
        <div class="main-footer__info p1">
            ...
            <p class="copy">COPYRIGHT &copy; 2020 시원플란트치과 ALL RIGHTS RESERVED</p>
        </div>
    </div>
</footer>
<div class="quick" id="quick">
    <ul>
        ...
        <li class="quick__talk"><a href="https://talk.naver.com/W4UOCQ" target="_blank" rel="noopener noreferrer"><i class="q-icon talk-icon"></i> 네이버톡톡</a></li>
        <li class="quick__top"><a href="#" class="top-btn"><img src="/layouts/seeoneplant/img/top.png" alt="top"></a></li>
    </ul>
</div>
<div class="modal-container">
    <div class="modal-wrapper">
        ...
        <div class="modal-content" id="doctor02">
            <img src="/layouts/seeoneplant/img/doctor02-modal-cnt-200805.jpg" alt="김형종 원장">
        </div>
