...
<section class="x_modal x" id="__category_info" hidden>
	<?php Context::addJsFile("modules/document/ruleset/insertCategory.xml", FALSE, "", 0, "body", TRUE, "") ?><form  id="fo_category" action="./" method="post" class="x_form x_form-horizontal" style="margin:0"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" /><input type="hidden" name="ruleset" value="insertCategory" />
