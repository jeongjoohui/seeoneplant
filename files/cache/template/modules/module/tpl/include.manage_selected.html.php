...
<section id="manageSelectedModule" class="x_modal x">
	<div class="x_modal-header">
		<h1><?php echo $lang->do_selected ?></h1>
	</div>
	<div class="x_modal-body">
		...
		<div class="x_tabbable">
			<ul class="x_nav x_nav-tabs">
				<?php if($__Context->tabChoice['tab1']){ ?><li class="x_active"><a href="#tab1"><?php echo $lang->bundle_setup ?></a></li><?php } ?>
				<?php if($__Context->tabChoice['tab2']){ ?><li><a href="#tab2"><?php echo $lang->bundle_addition_setup ?></a></li><?php } ?>
				<?php if($__Context->tabChoice['tab3']){ ?><li><a href="#tab3"><?php echo $lang->bundle_grant_setup ?></a></li><?php } ?>
			</ul>
	...
	<div class="x_modal-footer">
		<button type="button" class="x_btn x_pull-left" data-hide="#manageSelectedModule"><?php echo $lang->cmd_close ?></button>
	</div>
</section>
