...
<div class="x_alert x_alert-info" id="widgetInfo" hidden><p><?php echo $__Context->widget_info->description ?></p></div>
<div class="x_alert x_alert-info" id="codeHelp" hidden><p><?php echo $lang->about_widget_code ?></p></div>
<form id="widget_code_form" class="x_form-horizontal" action="./" method="post"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
	...
	<div class="x_clearfix btnArea">
		<a href="<?php echo getUrl('', 'module', 'admin', 'act', 'dispWidgetAdminDownloadedList') ?>" class="x_btn x_pull-left"><?php echo $lang->cmd_list ?></a>
		<input type="submit" class="x_btn x_btn-primary" value="<?php echo $lang->cmd_generate_code ?>" />
	</div>
</form>
<div class="x_well">
	<h3><?php echo $lang->widget_code ?></h3>
