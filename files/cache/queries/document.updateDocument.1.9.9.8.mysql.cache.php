...
${'last_update19_argument'}->ensureDefaultValue(getInternalDateTime());
...
${'ipaddress20_argument'}->ensureDefaultValue(\RX_CLIENT_IP);
...
new ConditionWithArgument('`document_srl`',$document_srl27_argument,"equal", 'and')),'and')
));
