...
new Table('`rx_tags`', '`T`')
,new Table('`rx_documents`', '`D`')
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithoutArgument('T.`document_srl`','D.`document_srl`',"equal", 'and')
,new ConditionWithoutArgument('D.`module_srl`','0',"notequal", 'and')
,new ConditionWithArgument('T.`module_srl`',$module_srl1_argument,"in", 'and')),'and')
));
