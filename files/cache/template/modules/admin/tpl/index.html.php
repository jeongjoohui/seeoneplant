...
<!--#Meta:modules/admin/tpl/css/jquery.jqplot.min.css--><?php $__tmp=array('modules/admin/tpl/css/jquery.jqplot.min.css','','','',array());Context::loadFile($__tmp);unset($__tmp); ?>
<div class="content" id="content">
	...
	<?php if($__Context->XE_VALIDATOR_MESSAGE && $__Context->XE_VALIDATOR_ID == 'modules/admin/tpl/index/1'){ ?><div class="message <?php echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->XE_VALIDATOR_MESSAGE_TYPE, ENT_QUOTES, 'UTF-8', false) : ($__Context->XE_VALIDATOR_MESSAGE_TYPE)) ?>">
	...
	<?php if($__Context->addTables || $__Context->needUpdate){ ?><div class="message update">
		...
		<ul>
			<?php if($__Context->module_list)foreach($__Context->module_list as $__Context->key=>$__Context->value){ ?>
				<?php if($__Context->value->need_install){ ?><li style="margin:0 0 4px 0">
				...
				<?php if($__Context->value->need_update){ ?><li style="margin:0 0 4px 0">
					<?php echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->value->title, ENT_QUOTES, 'UTF-8', false) : ($__Context->value->title)) ?> (<?php echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->value->module, ENT_QUOTES, 'UTF-8', false) : ($__Context->value->module)) ?>)
