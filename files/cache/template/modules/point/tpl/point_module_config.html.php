...
<section class="section">
	...
	<form action="./" method="post" id="fo_point" class="x_form-horizontal"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="number" name="voter" id="voter" value="<?php echo $__Context->module_config['voter'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="blamer" class="x_control-label"><?php echo $lang->point_blamer ?></label>
			<div class="x_controls">
				<input type="number" name="blamer" id="blamer" value="<?php echo $__Context->module_config['blamer'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="voter_comment" class="x_control-label"><?php echo $lang->point_voter_comment ?></label>
			<div class="x_controls">
				<input type="number" name="voter_comment" id="voter_comment" value="<?php echo $__Context->module_config['voter_comment'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="blamer_comment" class="x_control-label"><?php echo $lang->point_blamer_comment ?></label>
			<div class="x_controls">
				<input type="number" name="blamer_comment" id="blamer_comment" value="<?php echo $__Context->module_config['blamer_comment'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="download_file_author" class="x_control-label"><?php echo $lang->point_download_file_author ?></label>
			<div class="x_controls">
				<input type="number" name="download_file_author" id="download_file_author" value="<?php echo $__Context->module_config['download_file_author'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="read_document_author" class="x_control-label"><?php echo $lang->point_read_document_author ?></label>
			<div class="x_controls">
				<input type="number" name="read_document_author" id="read_document_author" value="<?php echo $__Context->module_config['read_document_author'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
		...
		<div class="x_control-group">
			...
			<div class="x_controls">
				<input type="number" name="voted_comment" id="voted_comment" value="<?php echo $__Context->module_config['voted_comment'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
		<div class="x_control-group">
			<label for="blamed_comment" class="x_control-label"><?php echo $lang->point_blamed_comment ?></label>
			<div class="x_controls">
				<input type="number" name="blamed_comment" id="blamed_comment" value="<?php echo $__Context->module_config['blamed_comment'] ?>" /> <?php echo $__Context->module_config['point_name'] ?>
			</div>
		</div>
