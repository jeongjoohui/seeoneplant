...
echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->value->getTitle(), ENT_QUOTES, 'UTF-8', false) : ($__Context->value->getTitle()));
				...
				<form class="action" method="POST"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
...
echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->value->getSummary(), ENT_QUOTES, 'UTF-8', false) : ($__Context->value->getSummary()));
				...
				<span class="side"><?php echo ($this->config->autoescape === 'on' ? htmlspecialchars($__Context->value->getNickName(), ENT_QUOTES, 'UTF-8', false) : ($__Context->value->getNickName())) ?></span> 
				<form class="action"><input type="hidden" name="error_return_url" value="<?php echo escape(getRequestUriByServerEnviroment(), false); ?>" /><input type="hidden" name="mid" value="<?php echo $__Context->mid ?>" /><input type="hidden" name="vid" value="<?php echo $__Context->vid ?>" />
					<input type="hidden" name="module" value="admin" />
