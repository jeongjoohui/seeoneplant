...
,new SelectExpression('M.`member_srl`')
,new SelectExpression('M.`user_name`')
,new SelectExpression('M.`user_id`')
,new SelectExpression('M.`nick_name`')
));
$query->setTables(array(
new Table('`rx_poll_title`', '`P`')
,new JoinTable('`rx_poll`', '`P2`', "left join", array(
new ConditionGroup(array(
new ConditionWithoutArgument('`P2`.`poll_srl`','`P`.`poll_srl`',"equal")),'and')
))
,new JoinTable('`rx_member`', '`M`', "left outer join", array(
new ConditionGroup(array(
new ConditionWithoutArgument('`P2`.`member_srl`','`M`.`member_srl`',"equal")),'and')
))
));
$query->setConditions(array(
new ConditionGroup(array(
new ConditionWithArgument('`poll_index_srl`',$pollIndexSrlList1_argument,"in", 'and')),'and')
,new ConditionGroup(array(
