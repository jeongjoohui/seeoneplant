...
v.cast('ADD_FILTER',['fileModuleConfig', {'allowed_filesize':{required:true,rule:'float',default:'2'},'allowed_attach_size':{required:true,rule:'float',default:'2'}}]);
v.cast('ADD_MESSAGE',['allowed_filesize','파일 용량 제한']);
